...
public class Main {
    ...
    private static void typeAllFullName() {
...
////    }
    ...
    public static void main (String[] args) {
        ...
        employees[0] = new Employee("Воронина Алена Викторовна", 1, 51153);
        employees[1] = new Employee("Воробьев Александр Николаевич", 2, 50000);
        employees[2] = new Employee("Чередник Илья Андреевич", 3, 52000);
        employees[3] = new Employee("Цыхмистров Владимир Петрович", 4, 53000);
        employees[4] = new Employee("Андреев Олег Владимирович", 5, 54000);
        employees[5] = new Employee("Кармазаин Сергей Александрович", 1, 55000);
        employees[6] = new Employee("Исаева Виктория Владимировна", 2, 56000);
        employees[7] = new Employee("Шашкова Анастасия Андреевна", 3, 57000);
        employees[8] = new Employee("Пичугин Максим Владимирович", 4, 58000);
        employees[9] = new Employee("Чесноков Александр Андреевич", 5, 59000);
        typeAllFullName();
        monthSalary();
        countMinSalary();
        countMaxSalary();
